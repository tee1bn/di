...
<body class="fix-header card-no-border">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                       <!--  <li class="nav-item hidden-sm-down">
                        ...
                        <li class="nav-item dropdown">
                            <span class="text-success"><?=$this->admin()->fullname;?></span>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                     ...
                     <!--  
                        <li>
                            <a href="<?=domain;?>/admin/dashboard" aria-expanded="false">
 ...
 -->
                        ...
                        <li>
                            <a class="has-arrow " href="#" aria-expanded="false"><i class="fa fa-link"></i><span class="hide-menu">Matching</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?=domain;?>/admin/matches">Matches</a></li>
                                <li><a href="<?=domain;?>/admin/manual_matches">Manual Matching</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?=domain;?>/admin/write-testimony">Letter of Happiness</a></li>
                            </ul>
                        </li>
