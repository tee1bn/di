    ...
    <section class="hero">
      <div class="container text-center">
        <nav aria-label="breadcrumb" class="d-flex justify-content-center">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#" class="animsition-link">Home</a></li>
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <p class="lead text-muted">A Participant Invests from as little as R500 to a Maximum R5000 with an income withdrawal of 50% per week which is 100% in a month. It takes 24 hours before a member is matched with a Participant to donate,12 hours to honor the order and 5 days for the order to mature. Failing to pay your order in time you’re blocked. All withdrawals  are 50% of money invested in from first payment to the last. YOU DOUBLE YOUR MONEY IN LESS THAN A WEEK. .</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            <p><img src="<?=$this_folder;?>/img/blog1.jpg" alt="..." class="img-fluid"></p>
