...
<html>
  ...
  <body>
    ...
    <!-- navbar-->
    <header class="header" >
      <nav class="navbar navbar-expand-lg fixed-top" style="background: #1b1b1b;">
        <div class="container"><a href="./" class="navbar-brand"><img src="<?=$logo;?>" style="
    height: 41px;
    width: 117px;" alt="" class="img-fluid"></a>
          <button type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="text-white navbar-toggler navbar-toggler-right">Menu<i class="fa fa-bars ml-2"></i></button>
          <div id="navbarSupportedContent" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                  <!-- Link-->
                  <li class="nav-item"> <a href="<?=domain;?>" class="nav-link text-white active">Home</a></li>
                  <!-- Link-->
                  <li class="nav-item"> <a href="<?=domain;?>/w/about" class="nav-link text-white">About</a></li>
                  <!-- Link-->
                  <li class="nav-item"> <a href="<?=domain;?>/w/how_it_works" class="nav-link text-white">How it works</a></li>
                  <!-- Link-->
